    ...
    return (
        <View style={Style.container}>
            ...
            <View style={{ marginTop: 50 }}>
                <ButtonStyle1 title="REGISTER" />
            </View>
            <View style={Style.noAccount}>
                <Text style={Style.fontReguler}>You have account? </Text>
                <Pressable><Text style={Style.fontBold} onPress={navigateLogin}> Login</Text></Pressable>
            </View>
        </View>
    )
}
